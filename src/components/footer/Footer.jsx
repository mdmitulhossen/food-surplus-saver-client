            ...
            <footer className="bg-[#0C4428]/90">
                <div className="foodContainer pt-16 pb-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        <div className="col-span-full lg:col-span-1">
                            ...
                            <a className="flex-none text-xl font-semibold text-white" href="#" aria-label="Brand">Food-Surplus-Saver</a>
                        </div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="mt-3 grid space-y-3">
                                <p><a className="inline-flex gap-x-2 text-gray-300 hover:text-gray-200" href="#">About us</a></p>
                                <p><a className="inline-flex gap-x-2 text-gray-300 hover:text-gray-200" href="#">Blog</a></p>
                                <p><a className="inline-flex gap-x-2 text-gray-300 hover:text-gray-200" href="#">Careers</a> <span className="inline ml-1 text-xs bg-[#8DC53E] text-white py-1 px-2 rounded-md">We're hiring</span></p>
                                <p><a className="inline-flex gap-x-2 text-gray-300 hover:text-gray-200" href="#">Customers</a></p>
                            </div>
                        </div>
                ...
                <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center bg-[#0C4428] foodContainer">
                    <div className="flex justify-between items-center">
                        <p className="text-sm text-gray-300">© 2023 Food-surplus-Saver. All rights reserved.</p>
                    </div>
